...
(function ($) {
    $.fn.imageUploader = function (options) {
        ...
        let defaults = {
            ...
            extensions: ['.jpg', '.jpeg', '.png', '.gif', '.svg', '.mp4', '.webm', '.mov', '.mp3', '.wav'],
            mimes: ['image/jpeg', 'image/png', 'image/gif', 'image/svg+xml', 'video/mp4', 'video/webm', 'video/quicktime', 'audio/mpeg', 'audio/wav'],
            maxSize: undefined,
            maxFiles: undefined,
            capture: null,
