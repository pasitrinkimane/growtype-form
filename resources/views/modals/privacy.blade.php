    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="privacyModalLabel"><?php echo __(
                    "Privacy policy",
                    "growtype-form",
                ); ?></h5>
            ...
            <div class="modal-body">
                <?php echo growtype_form_get_signup_privacy_page_content(); ?>
                <div class="content-shadow"></div>
            </div>
            <div class="modal-footer justify-content-center" style="display: none;">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><?php __(
                    "I Disagree",
                    "growtype",
                ); ?></button>
