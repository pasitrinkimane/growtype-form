    ...
    <div class="container">
        <form class="verificationinfo" method="post" action="{{ $action }}">
            <div class="verificationinfo-inner">
                ...
                <hr/>
                <p style="max-width: 320px;margin: auto;">{!! sprintf(__("If you still can't connect, please contact our support at %s.", 'growtype-form'), '<a href="mailto:info@talkiemate.com">info@talkiemate.com</a>') !!}</p>
            </div>
